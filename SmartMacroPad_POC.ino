/*
  Smart MacroPad POC Firmware
  Board target: Seeed XIAO ESP32S3 / ESP32-S3 with native USB

  What this proves:
  - 6 keys work
  - rotary encoder works
  - knob press changes mode
  - OLED displays current mode + last action
  - optional USB keyboard/media shortcuts can be added later

  Libraries needed in Arduino IDE:
  - Adafruit GFX Library
  - Adafruit SSD1306

  Change the pin numbers below to match your final PCB.
*/
...
// -------- RANDOM POC PIN NUMBERS - CHANGE LATER --------
// Keys: one side of each switch to GPIO, other side to GND.
...
// Optional OLED reset pin. Set to -1 if not used.
